 ...
 * 旧样式下拉刷新头
 */
public class CorePtrOldHeader extends FrameLayout implements PtrUIHandler {
    ...
    public CorePtrOldHeader(Context context) {
        super(context);
        initViews(null);
    }

    public CorePtrOldHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public CorePtrOldHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.core_cube_ptr_classic_default_header, this);
